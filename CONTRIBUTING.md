...
./.venv/bin/python tests/test_auth.py tests/test_deid.py tests/test_dicomweb.py \
                   tests/test_index.py tests/test_modalities.py tests/test_qr.py \
                   tests/test_ris.py tests/test_routing.py tests/test_web_auth.py \
                   tests/test_worklist_probe.py
